...
if __name__ == "__main__":
    ...
    plotter.plot("drop_percentage", "rounds", "Drop rate vs Rounds")
    plotter.plot("drop_percentage", "elapsed_times", "Drop rate vs Consensus Time")
